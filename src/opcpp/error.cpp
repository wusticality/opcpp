...
/// Description:
///
/// Contains source code for error logging, including initialization of errors,
/// etc.
///****************************************************************
...
void opError::InitParseErrors() {
    ...
    for (int i = 0; i < Tokens_MAX; i++) {
        ...
        if (TokenFunctions::IsTerminal(t))
            ...
            ParseErrors[t] =
                TokenFunctions::ToString(t) +
                " parse error uninitialized ... please report to www.opcpp.com";
    }
    ...
    ParseErrors[G_NAMESPACEBLOCK] =
        "namespace Name {" LCHEV " ... " RCHEV "}";           // ErrorNamed
    ...
    ParseErrors[G_OPENUM_BODY] =
        "openum Name {" LCHEV " ... " RCHEV "};";          // ErrorNamed
    ParseErrors[G_OPENUM_ELEMENT] = "EnumName [= ... ],";  // ErrorNamed
    ParseErrors[G_OPENUM_INITIALIZATION] =
        "EnumName = " LCHEV " Value " RCHEV ",";                // ErrorNamed
    ParseErrors[G_OPOBJECT_INHERITANCE] = ": Visibility Name";  // ErrorNamed
    ParseErrors[G_STATE] = "state Name { ... }";                // ErrorNamed;
    ParseErrors[G_STATEBLOCK] =
        "state Name {" LCHEV " ... " RCHEV "}";            // ErrorNamed;
    ...
    ParseErrors[G_FUNCTION_DEFINITION] =
        "ReturnType FunctionName( ... ) { ... }";  // ErrorNamed
    ParseErrors[G_FUNCTION_PROTOTYPE] =
        "ReturnType FunctionName( ... )";                   // ErrorNamed
    ...
    ParseErrors[G_CONSTRUCTOR_DEFINITION] =
        "Constructor( ... ) { ... }";  // ErrorNamed
    ParseErrors[G_CONSTRUCTOR_INITIALIZER_LIST] =
        "Constructor( ... ) : " LCHEV " ... " RCHEV;  // ErrorNamed
    ParseErrors[G_CONSTRUCTOR_INITIALIZER] = "Initializer( ... )";  // ErrorNamed
    ParseErrors[G_CONSTRUCTOR_INITIALIZER_ARGUMENT] =
        "Initializer(" LCHEV " ... " RCHEV ")";  // ErrorNamed
    ...
    ParseErrors[G_VISIBILITY_LABEL] =
        "public: or private: or protected:";      // ErrorNamed
    ...
    ParseErrors[G_FUNCTION_POINTER] =
        "ReturnType ( *Name )( ... )";  // ErrorNamed
    ParseErrors[G_FUNCTION_POINTER_DECL] =
        "ReturnType (" LCHEV " *Name " RCHEV ")( ... )";  // ErrorNamed
    ParseErrors[G_OPERATOR] = "operator OperatorName";    // ErrorNamed
    ParseErrors[G_OPDEFINE] =
        "opdefine Name [optional ( ... )] { ... }";  // ErrorNamed
    ParseErrors[G_OPDEFINE_BODY] = "opdefine Name [optional ( ... )] {" LCHEV
                                   " ... " RCHEV "}";  // ErrorNamed
    ParseErrors[G_OPMACRO] =
        "opmacro Name [optional ( ... )] { ... }";  // ErrorNamed
    ParseErrors[G_OPMACRO_BODY] = "opmacro Name [optional ( ... )] {" LCHEV
                                  " ... " RCHEV "}";  // ErrorNamed
    ParseErrors[G_OPMACRO_ARGUMENT] = "[optional 'argument'] Name";  // ok
    ParseErrors[G_OPMACRO_ARGUMENT_LIST] =
        "opmacro Name (" LCHEV " ... " RCHEV ")";  // ErrorNamed
    ParseErrors[G_POUND_DEFINE] =
        "Standard C++ #define Definition";                        // ErrorNamed
    ...
    ParseErrors[G_POUND_IFNDEF] =
        "Standard C++ #ifndef Definition";  // ErrorNamed
    ParseErrors[G_POUND_IMPORT] =
        "Standard C++ #import Definition";  // ErrorNamed
    ParseErrors[G_POUND_INCLUDE] =
        "Standard C++ #include Definition";                       // ErrorNamed
    ParseErrors[G_POUND_LINE] = "Standard C++ #line Definition";  // ErrorNamed
    ParseErrors[G_POUND_PRAGMA] =
        "Standard C++ #pragma Definition";  // ErrorNamed
    ...
    ParseErrors[G_POUND_WARNING] =
        "Standard C++ #warning Definition";               // ErrorNamed
    ParseErrors[G_OPINCLUDE] = "opinclude \"Filename\"";  // ErrorNamed
    ParseErrors[G_OPOBJECT] =
        "CategoryType Name [ : Visibility Inheritance ] { ... }";  // ErrorNamed
    ParseErrors[G_OPOBJECT_INHERITANCE] =
        ": Visibility Inheritance";  // ErrorNamed
    ParseErrors[G_OPOBJECT_BODY] =
        "CategoryType Name {" LCHEV " ... " RCHEV "}";  // ErrorNamed
    ParseErrors[G_EXPAND_CALL] = "expand Name( ... )";  // ErrorNamed
    ParseErrors[G_EXPAND_CALL_ARGUMENT_LIST] =
        "expand Name(" LCHEV " ... " RCHEV ")";  // ErrorNamed
    ParseErrors[G_EXPAND_CALL_ARGUMENT] =
        ParseErrors[G_EXPAND_CALL_ARGUMENT_LIST];  // ok
    ...
    ParseErrors[G_VALUED_MODIFIER_ARGUMENT] =
        "Modifier(" LCHEV " ... " RCHEV ")";  // ErrorNamed
    ParseErrors[G_FRIEND] =
        "friend [optional class/struct] Name or friend FunctionPrototype or "
        "friend FunctionDefinition";  // ErrorNamed
    ParseErrors[G_MODIFIERS] =
        "Modifiers";  // TODO: what does this do? ever get called?
    ParseErrors[G_AUTO_MODIFIERS] =
        "Modifiers";  // TODO: what does this do? ever get called?
    ParseErrors[G_TYPEDEF] =
        "typedef [optional const/volatile] Type Name";  // ErrorNamed
    ...
    ParseErrors[G_FUNCTION_DEFINITION_STATEMENT] =
        "Modifiers ReturnType FunctionName( ... ) { ... }";  // ErrorNamed
    ParseErrors[G_VISIBILITY_STATEMENT] =
        ParseErrors[G_VISIBILITY_LABEL];  // ok?
    ParseErrors[G_PREPROCESSOR_STATEMENT] = "C++ preprocessor statement";
    ParseErrors[G_NULL_STATEMENT] = ";";  // ok?
    ParseErrors[G_FRIEND_STATEMENT] =
        "friend [optional class/struct] Name;";  // ErrorNamed
    ParseErrors[G_TYPEDEF_STATEMENT] =
        "typedef [optional const/volatile] Type Name;";  // ErrorNamed
    ParseErrors[G_FUNCTION_POINTER_STATEMENT] =
        "Modifiers ReturnType (*Name)( ... );";             // ErrorNamed
    ParseErrors[G_STATE_STATEMENT] = "state Name { ... }";  // ErrorNamed
    ParseErrors[G_FUNCTION_PROTOTYPE_STATEMENT] =
        "Modifiers ReturnType FunctionName( ... );";             // ErrorNamed
    ParseErrors[G_DATA_STATEMENT] = "Modifiers Type Name;";      // ErrorNamed
    ParseErrors[G_TEMPLATE_STATEMENT] = "template< ... > ...;";  // ErrorNamed
    ParseErrors[G_CONSTRUCTOR_DEFINITION_STATEMENT] =
        "Modifiers Constructor( ... ) { ... }";  // ErrorNamed
    ParseErrors[G_CONSTRUCTOR_PROTOTYPE_STATEMENT] =
        "Modifiers Constructor( ... );";  // ErrorNamed
    ParseErrors[G_DESTRUCTOR_DEFINITION_STATEMENT] =
        "Modifiers ~Destructor( ... ) { ... }";  // ErrorNamed
    ParseErrors[G_DESTRUCTOR_PROTOTYPE_STATEMENT] =
        "Modifiers ~Destructor( ... );";
    ...
    ParseErrors[G_CATEGORY_BODY] =
        "category Name {" LCHEV " ... " RCHEV "}";             // ErrorNamed
    ParseErrors[G_CATEGORY_DATAMAP] = "datamap Name { ... }";  // ErrorNamed
    ParseErrors[G_CATEGORY_FUNCTIONMAP] =
        "functionmap Name { ... }";  // ErrorNamed
    ParseErrors[G_DATAMODIFIER] =
        "datamodifier Name or datamodifier Name()";  // ErrorNamed
    ParseErrors[G_FUNCTIONMODIFIER] =
        "functionmodifier Name or functionmodifier Name()";  // ErrorNamed
    ParseErrors[G_IS] = "is ModifierExpression";             // ErrorNamed
    ParseErrors[G_IS_BODY] = "is " LCHEV " ModifierExpression " RCHEV;
    ParseErrors[G_CRITERIA_ARGUMENT] =
        "\"Criteria Regex Pattern\"";                            // ErrorNamed
    ParseErrors[G_CATEGORY_LOCATION] = "location Name { ... }";  // ErrorNamed
    ParseErrors[G_CATEGORY_LOCATION_BODY] =
        "location Name {" LCHEV " ... " RCHEV "}";  // ErrorNamed
    ParseErrors[G_NOTE] = "note Name";              // ErrorNamed
    ParseErrors[G_NOTE_BODY] = "note Name {" LCHEV " ... " RCHEV "}";
    ParseErrors[G_NOTE_DEFINITION] =
        "note specifier::tag::subtag... ( ... ) { ... }";  // ErrorNamed
    ParseErrors[G_NOTE_DEFINITION_ARGUMENT_LIST] =
        "note specifier::tag::subtag... (" LCHEV " ... " RCHEV
        ")";                                                       // ErrorNamed
    ...
    ParseErrors[G_MODIFIER_ARGUMENT] =
        "ModifierName(" LCHEV " \"optional regex expression\" " RCHEV
        ")";  // ErrorNamed
    ParseErrors[G_CATEGORY_MAP_BODY] =
        "map Name {" LCHEV " ... " RCHEV "}";                 // ErrorNamed
    ParseErrors[G_ENUMERATION] = "enumeration Name { ... }";  // ErrorNamed
    ParseErrors[G_ENUMERATION_BODY] =
        "enumeration Name {" LCHEV " ... " RCHEV "}";  // ErrorNamed
    ParseErrors[G_ENUMERATION_LOCATION] = "location Name { ... }";  // ErrorNamed
    ParseErrors[G_ENUMERATION_LOCATION_BODY] =
        "location Name {" LCHEV " ... " RCHEV "}";    // ErrorNamed
    ...
    ParseErrors[G_CRITERIA_VALUE_MODIFIER] =
        "Modifier(\"optional regex pattern\")";
    ...
    ParseErrors[G_FILE_DECLARATION_BODY] =
        "file Name {" LCHEV " ... " RCHEV "}";
    ...
    ParseErrors[G_DATAMODIFIER_STATEMENT] =
        "datamodifier Name; or datamodifier Name();";
    ParseErrors[G_FUNCTIONMODIFIER_STATEMENT] =
        "functionmodifier Name; or functionmodifier Name();";
    ParseErrors[G_CATEGORY_LOCATION_STATEMENT] =
        ParseErrors[G_CATEGORY_LOCATION];
    ...
    ParseErrors[G_ENUMERATION_LOCATION_STATEMENT] =
        ParseErrors[G_ENUMERATION_LOCATION];
    ParseErrors[G_CPPCONSTRUCT_STATEMENT] = "C++ class, struct or enum";
    ParseErrors[G_FILE_DECLARATION_LOCATION_STATEMENT] =
        ParseErrors[G_FILE_DECLARATION_LOCATION];
    ParseErrors[G_DIALECT_NAMESPACE_STATEMENT] =
        ParseErrors[G_DIALECT_NAMESPACE];
...
void opError::PrintMissingErrors() {
    ...
    if (!opParameters::Get().DeveloperMode) return;
    ...
    for (int i = 0; i < Tokens_MAX; i++) {
        ...
        if (!TokenFunctions::IsTerminal(t) &&
            !TokenFunctions::IsStartEndToken(t) && !ParseErrors[t].Length()) {
            bMissing = true;
            break;
        }
    }
    ...
    for (int i = 0; i < Tokens_MAX; i++) {
        ...
        if (!TokenFunctions::IsStartEndToken(t) && !ParseErrors[t].Length()) {
            ParseErrors[t] =
                TokenFunctions::ToString(t) +
                " parse error uninitialized ... please report to www.opcpp.com";

            Log(opString(__FILE__) + "(" + opString(ErrorPosition) +
                ") : " + TokenFunctions::ToString(t));
        }
    }
...
void opError::Clear() { Errors.Clear(); }
...
void opError::TruncateErrorName(opString& name) {
    if (name.Length() > MaxErrorNameLength) {
        ...
        if (name[MaxErrorNameLength - 1] != ' ') name += " ";
...
bool opError::SortFunctor(const ErrorInfo& e1, const ErrorInfo& e2) {
    if (e1.File == e2.File) return e1.Line < e2.Line;
...
opString opError::ContextString() {
    if (!ContextNode) return ParseErrors[ContextToken];
...
void opError::RedefinitionError(const opString& name, opNode* olddef,
                                opNode* newdef) {
    opString error = "\t'";
    ...
    error += "\n\t";
    error += olddef->GetFile()->GetAbsoluteFileName() + '(' +
             olddef->GetLine() + ") : ";
...
void opError::MemberNameSameAsCategoryNameError(const opString& name,
                                                opNode* category, opNode* def) {
...
void opError::ReverseExpectError(const vector<Token>& expected, opNode* got,
                                 opNode* before) {
    int size = (int)expected.size();
    opString spacer = "\t          or '";
    opString error;
...
// Reached premature end of <location>, Expected <list of grammars> in context
// <Context>
...
// Reached premature end of <location>, Expected <list of grammars> in context
// <Context>
void opError::PrematureError(const vector<Token>& expected, opNode* beginning,
                             bool bEOF) {
    int size = (int)expected.size();
...
void opError::GetDataModifierList(const opString& spacer,
                                  opString& modifierlist, opNode* innernode) {
...
void opError::GetFunctionModifierList(const opString& spacer,
                                      opString& modifierlist,
                                      opNode* innernode) {
    OPObjectNode* object = innernode->FindParent<OPObjectNode>();
    DialectCategory* category = object->GetCategorySettings();
...
void opError::GetList(const opString& spacer, opString& output,
                      opSet<opString>& list) {
...
void opError::ExpandError(opNode* node, const opString& signature,
                          const opSymbolTracker& tracker) {
    // TODO: improve this error, it should print out similar signatures!
    //      "... did you mean ...?"
    MessageError(node, opString("opmacro ") + signature +
                           " not found, check name and arguments.");
}
...
void opError::InvalidValueError(ValuedModifierNode* modifier,
                                ModifierNodeBase* definition) {
    ...
    error +=
        modifier->GetModifier()->GetValue() + "() value '" + value + "' : ";
...
void opError::NoteRedeclaredError(DialectNote* oldnote, NoteNode* newnote) {
    ...
    if (notenode) {
        error += "\n\t";
        error += notenode->GetFile()->GetAbsoluteFileName() + '(' +
                 notenode->GetLine() + ") : ";
        error += "see original definition";
    }
...
void opError::MessageError(opNode* node, const opString& message,
    ...
    if (bThrowException) opException::ThrowException();
}
...
void opError::MapRedeclaredError(DialectMap* oldmap, CategoryMapNode* newmap) {
    ...
    if (mapnode) {
        error += "\n\t";
        error += mapnode->GetFile()->GetAbsoluteFileName() + '(' +
                 mapnode->GetLine() + ") : ";
        error += "see original definition";
    }
...
void opError::NameCollisionError(const opString& name, opNode* oldnode,
                                 opNode* newnode) {
    ...
    error += "\n\t";
    error += oldnode->GetFile()->GetAbsoluteFileName() + '(' +
             oldnode->GetLine() + ") : ";
    error += "see original definition";
...
void opError::OperandError(opNode* node, DialectExpressionMap* map,
                           const opString& operandname) {
    opString spacer;
    opString error = "\tInvalid modifier '";
...
void opError::InvalidExtensionError(opNode* node, const opString& name,
                                    const opString& type) {
    opString error =
        "\tNo extension is registered for the " + type + " '" + name + "'.\n";
    opString spacer;
...
void opError::NoteDefinitionError(NoteDefinitionNode* oldnode,
                                  NoteDefinitionNode* newnode) {
...
void opError::AltPrefixRedefinitionError(const opString& type,
                                         opNode* oldprefix, opNode* newprefix) {
    opString error = "\tOnly one alternate prefix is allowed per ";

    error += type;
    error += "!\n\t";

    error += oldprefix->GetFile()->GetAbsoluteFileName() + '(' +
             oldprefix->GetLine() + ") : ";
    error += "see original definition";
