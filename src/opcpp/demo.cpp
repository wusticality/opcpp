...
const char* opDemoSupport::GetDemoBanner() {
    if (!opDemoSupport::IsDemoMode()) return "";
    ...
    return "..................................................................."
           ...
           "................ ..............................................\n"
           "........MOOON...78ODMMZNOOOOOOOOOOOOOOO8N. ..........:M. "
           "............. .M,..............................................\n"
           ".......?NO~..NOD,..DOOOOO....... ==....DO8N........ "
           "O8.?OOOOOOOOOOOOOOZ..D............................................."
           ".\n"
           "......~OZ ..OOOOOO..+OOOOOOZ...8OOOOO? "
           "..8OM........M.,OOOOOOOOOOOOOOOO..D..... ..... ............. . "
           "..................\n"
           "......NO...OOOOOOOZ..DOOOOO8...OOOOOOO,...ODD.......M.:"
           "OOOOOOOOOOOOOOOO..D.....$M8888MM............,MN8888MZ ...........\n"
           ".....MO=..ZOOOOOOO8...OOOOO8...OOOOOOOD...IOM.......M.:OOOO........"
           "OOOO..D....:? ......M...........N.......$,...........\n"
           ".....D8...DOOOOOOOO...$OOOO8...OOOOOOO8...=OM.......M.:OOOO.=MMMM.."
           "OOOO..D....~=.OOOO~.M...........M.,OOOO ?,...........\n"
           "... NO$.. "
           "OOOOOOOOO=...OOOO8...OOOOOOOD...?OM.......M.:OOOO.~~..D~...... "
           "8....~=.OOOO~.M...........M.,OOOO ?,...........\n"
           "... NO....OOOOOOOOO7...MOOO8...OOOOOOO=...88M.......M.:OOOO.~~.. "
           "NNNDDNMM.NMMMM=.OOOO~.MMMMMD,8NMMMM.,OOOO ?NMMMN. .....\n"
           "....8O....OOOOOOOOOO....OOO8...OOOOOOO ..~OM........M.:OOOO.~~.... "
           "     ~7.......OOOO~. .... M .... .,OOOO...... 8,.....\n"
           "....8O "
           "...OOOOOOOOO8....OOO8...8OOOD....8OM,........M.:OOOO.~~..........?:"
           ".OOOOOOOOOOOOOOOO=.M.IOOOOOOOOOOOOOOOO..?.....\n"
           "....8O....OOOOOOOOOD....OOO8....,,,:+NZO8M..........M.:OOOO.~~....."
           ".....?:.OOOOOOOOOOOOOOOO=.M.IOOOOOOOOOOOOOOOO..?.....\n"
           "....8O....OOOOOOOOOO....OOO8...OOOOOOOM, "
           "...........M.:OOOO.~~..........?:.OOOOOOOOOOZOOOOO=.M "
           "?OOOOOOOOOOOOOOOO..?.....\n"
           "....NO....OOOOOOOOO7...DOOO8...OOOOOOOM.............M.:OOOO.~~.. "
           ".7DDDDO M.......OOOO~......7MI......,OOOO.... .:M .....\n"
           "....NO$ "
           "..OOOOOOOOO+...OOOO8...OOOOOO8M.............M.:OOOO.~~..$M......++."
           "   ~=.OOOO~.M    ....   M.,OOOO ?,   ........\n"
           "....:88...8OOOOOOOO...7OOOO8...OOOOOON+.............M.:OOOO.~~..N "
           ".OOOO..D....~=.OOOO~.M...........M.,OOOO ?,...........\n"
           ".....MO=..ZOOOOOOO8...OOOOO8...OOOOOOM "
           ".............M.:OOOO.~ZZZ$..OOOO..D....~+ ::::..M.......... "
           "M..::::.7............\n"
           "......DO...OOOOOOOZ  "
           "ZOOOOO8...OOOOOOM..............M.:OOOO........OOOO..D.....MN====?M."
           "...........~MI===~MM............\n"
           "......:O8...OOOOO8 "
           ".?OOOOOOZ...8OOOOON..............M.:OOOOOOOOOOOOOOOO..D......     "
           ". .............     .  ............\n"
           ".......$8O:..DO8=..DZOOOO+,.....,=8O8?............. "
           "M..OOOOOOOOOOOOOOOO..D............................................."
           ".\n"
           "........MOOOO...=DOOOOOOO8888888888OD,..............,M............."
           "......O..............................................\n"
           ...
           "..................................................................."
           ".....................................................\n"
           "......... Created with opC++ Demo Version - Buy to remove banner "
           "and licensing restrictions.               .............\n"
           "......... This generated code may be used for non-commercial and "
           "evaluation use ONLY.				        "
           ".............\n"
           "..................................................................."
           ".....................................................\n"
...
void opDemoSupport::PrintDemoString(opFileStream& stream, opString classname,
                                    OPObjectNode* object) {
    if (!opDemoSupport::IsDemoMode()) return;

    // 	DialectNote&        prefixnote	=
    // object->GetCategorySettings()->GetPrefixNote(); 	DialectNote&
    // postfixnote = object->GetCategorySettings()->GetPostfixNote();
    ...
    ValuedModifierNode* scope = node_cast<ValuedModifierNode>(
        object->OPTypeBase::GetContextArgument("scope"));
    stream.header << endl;
    ...
    stream.header << "}" << endl;
    stream.header << "static " << classname << randomletters1 << " "
                  << randomletters3 << ";" << endl;
    ...
    stream.header << "::" << classname << randomletters1 << " " << classname
                  << randomletters3 << ";" << endl;

    stream.source << classname << randomletters3 << " ";
    stream.source << classname << randomletters3 << "::" << randomletters3
                  << ";" << endl;
    stream.source << endl;
}
...
bool opDemoSupport::ValidateLicense(opParameters& params) {
    ...
    // opString key  = lines[0].RemoveWhitespace() + lines[1].RemoveWhitespace()
    // + opDemoSupport::ExtraHashString; opString hash =
    // lines[2].RemoveWhitespace();

    // // If the hash of the key does not match the hash in the file, we're in
    // demo mode. if (md5Encode(key) != hash)
    // {
    // 	DemoMode = true;
    // 	return false;
    // }
    ...
    // // If this key/hash combination has been blacklisted, then we're in demo
    // mode. if (IsBlacklisted(key, hash))
    // {
    // 	DemoMode = true;
    // 	return false;
    // }
