...
class DialectStatementBase : public opNode {
   public:
    ...
    virtual DialectStatementBase* ToDialectStatementBase() { return this; }
    ...
    void SetModifiers(DialectModifiersNode* innode) { Modifiers = innode; }

    void SetStatement(DialectNodeBase* innode) { Statement = innode; }

    /*=== get ===*/

    DialectModifiersNode* GetModifiers() { return Modifiers; }

    DialectNodeBase* GetStatement() { return Statement; }
...
class DataModifierStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(DataModifierStatementNode, DialectStatementBase,
    ...
    bool Parse() {
        PARSE_START;
        {
            if (Modifiers) {
                ...
                Modifiers->FindValuedDialectModifier<G_DESCRIPTION,
                                                     DescriptionNode>();
            }
        }
        PARSE_END;
...
class FunctionModifierStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(FunctionModifierStatementNode, DialectStatementBase,
...
class CategoryLocationStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(CategoryLocationStatementNode, DialectStatementBase,
                 G_CATEGORY_LOCATION_STATEMENT);

    bool Parse() {
        PARSE_START;
        {
            if (Modifiers) Modifiers->CheckNone();
        }
        PARSE_END;
    }
};
...
class DisallowStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(DisallowStatementNode, DialectStatementBase,
    ...
    bool PostParse() {
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                if (BeforeNode* before =
                        node_cast<BeforeNode>(Modifiers->GetModifier(G_BEFORE)))
                    notenode->SetOrder(before);
                // Else if this note has the after modifier, set it.
                else if (AfterNode* after = node_cast<AfterNode>(
                             Modifiers->GetModifier(G_AFTER)))
...
class EnumerationMapStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(EnumerationMapStatementNode, DialectStatementBase,
    ...
    bool PostParse() {
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                EnumerationMapNode* enummap =
                    node_cast<EnumerationMapNode>(Statement);
...
class EnumerationLocationStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(EnumerationLocationStatementNode, DialectStatementBase,
...
class CategoryDatamapStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(CategoryDatamapStatementNode, DialectStatementBase,
    ...
    bool PostParse() {
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                CategoryDatamapNode* datamap =
                    node_cast<CategoryDatamapNode>(Statement);
...
class CategoryFunctionmapStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(CategoryFunctionmapStatementNode, DialectStatementBase,
    ...
    bool PostParse() {
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                CategoryFunctionmapNode* functionmap =
                    node_cast<CategoryFunctionmapNode>(Statement);
...
class FileDeclarationLocationStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(FileDeclarationLocationStatementNode, DialectStatementBase,
        ...
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                FileDeclarationLocationNode* loc =
                    node_cast<FileDeclarationLocationNode>(Statement);
...
class DialectOPIncludeStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(DialectOPIncludeStatementNode, DialectStatementBase,
...
class CategoryStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(CategoryStatementNode, DialectStatementBase,
    ...
    bool Parse() {
        ...
        {
            if (Modifiers) {
                Modifiers->FindValuedDialectModifier<G_CLASS_PREFIX,
                                                     ClassPrefixNode>();
                Modifiers->FindValuedDialectModifier<G_STRUCT_PREFIX,
                                                     StructPrefixNode>();
            }
        }
        PARSE_END;
    ...
    bool PostParse() {
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                if (ClassPrefixNode* prefix = node_cast<ClassPrefixNode>(
                        Modifiers->GetModifier(G_CLASS_PREFIX)))
                    category->SetClassPrefix(prefix);
                // if we have a struct prefix, set it
                else if (StructPrefixNode* prefix = node_cast<StructPrefixNode>(
                             Modifiers->GetModifier(G_STRUCT_PREFIX)))
...
class EnumerationStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(EnumerationStatementNode, DialectStatementBase,
    ...
    bool Parse() {
        ...
        {
            if (Modifiers) {
                Modifiers->FindValuedDialectModifier<G_ENUM_PREFIX,
                                                     EnumPrefixNode>();
            }
        }
        PARSE_END;
        ...
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                EnumerationNode* enumeration =
                    node_cast<EnumerationNode>(Statement);

                // if we have an enum prefix, set it
                if (EnumPrefixNode* prefix = node_cast<EnumPrefixNode>(
                        Modifiers->GetModifier(G_ENUM_PREFIX)))
...
class DialectOPDefineStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(DialectOPDefineStatementNode, DialectStatementBase,
...
class NoteDefinitionStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(NoteDefinitionStatementNode, DialectStatementBase,
    ...
    bool PostParse() {
        POSTPARSE_START;
        {
            if (Modifiers) {
                ...
                NoteDefinitionNode* notedef =
                    node_cast<NoteDefinitionNode>(Statement);

                // If this node has the override modifier, set it on the note.
                if (OverrideNode* override = node_cast<OverrideNode>(
                        Modifiers->GetModifier(G_OVERRIDE)))
                    notedef->SetOverride(override);

                // If this node has the verbatim modifier, set it on the note.
                if (VerbatimNode* verbatim = node_cast<VerbatimNode>(
                        Modifiers->GetModifier(G_VERBATIM)))
...
class FileDeclarationStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(FileDeclarationStatementNode, DialectStatementBase,
...
class DialectNamespaceStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(DialectNamespaceStatementNode, DialectStatementBase,
...
class ExtensionStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(ExtensionStatementNode, DialectStatementBase,
...
class ExtendPointStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(ExtendPointStatementNode, DialectStatementBase,
...
class DialectOPMacroStatementNode : public DialectStatementBase {
   public:
    DECLARE_NODE(DialectOPMacroStatementNode, DialectStatementBase,
