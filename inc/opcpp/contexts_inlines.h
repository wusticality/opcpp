...
inline bool BasicTypes<Parent>::Parse() {
    PARSE_START;
    { this->FindBasicTypes(); }
    PARSE_END;
}
...
template <class Parent>
inline opString Declaration<Parent>::GetClassName() {
    ABSTRACT_FUNCTION;
    return "";
}
...
template <class Parent>
inline bool Declaration<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool State<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool Inheritance<Parent>::Parse() {
    PARSE_START;
...
template <class Parent>
inline bool NamespaceDecl<Parent>::Parse() {
    PARSE_START;
...
template <class Parent>
inline bool Global<Parent>::PreParse() {
    PREPARSE_START;
    { this->FindOPIncludes(); }
    PREPARSE_END;
}
...
template <class Parent>
inline bool Global<Parent>::Parse() {
    PARSE_START;
    {
        ConcatenationWalker performconcat(this);
...
template <class Parent>
inline bool Global<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline void Operator<Parent>::Init() {
    bCastOperator = false;
    OperatorType = NULL;
}
...
inline bool Operator<Parent>::Parse() {
    ...
    if (!this->IsCurrent(T_STAR)) this->FindPointers();

    if (!this->IsCurrent(T_AMPERSAND)) this->FindReferences();

    if (this->IsCurrent(G_POINTER) || this->IsCurrent(T_ID) ||
        this->IsCurrent(G_REFERENCE) || this->IsCurrent(G_SCOPE)) {
        bCastOperator = true;
...
template <class Parent>
inline bool Dialect<Parent>::Parse() {
    PARSE_START;
    {
        this->CleanAll();
        this->FindOPDefines();
...
template <class Parent>
inline bool Dialect<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool Category<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool CategoryLocation<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool CategoryMap<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool Enumeration<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool EnumerationLocation<Parent>::PostParse() {
    POSTPARSE_START;
...
template <class Parent>
inline bool FileDeclaration<Parent>::PostParse() {
    POSTPARSE_START;
