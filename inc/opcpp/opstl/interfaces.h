...
class pointer_iterator : public Iterator {
   public:
    ...
    pointer_iterator(Iterator iter) : Iterator(iter) {}
...
class const_pointer_iterator : public Iterator {
   public:
    ...
    const_pointer_iterator(Iterator iter) : Iterator(iter) {}
...
class reverse_pointer_iterator : public Iterator {
   public:
    ...
    reverse_pointer_iterator(Iterator iter) : Iterator(iter) {}
...
class const_reverse_pointer_iterator : public Iterator {
   public:
    ...
    const_reverse_pointer_iterator(Iterator iter) : Iterator(iter) {}
