...
// TODO: figure out a good way of inserting the code watermark (it has issues w/
// some things) 		I'm thinking a class in the header, and an
//initialization 		in the source, once per file errr...thats bad
//		issue is I need to print the front note for template
//types...hmmmm
...
class opDemoSupport {
   ...
   public:
    ...
    static bool IsDemoMode() { return DemoMode; }
    ...
    static void PrintDemoString(opFileStream& stream, opString classname,
                                OPObjectNode* object);
